...
all_cetaceans2 <- all_cetaceans %>%
  mutate(statusDate2 = ifelse(status == "Alive", "2017-05-07", statusDate)) %>%
...
```{r}
# coxph(formula = Surv(birthYear, statusyear, status2) ~ species + sex + accuracy + 
#         acquisition + transfertype + captivity, data = all_cetaceans2)
